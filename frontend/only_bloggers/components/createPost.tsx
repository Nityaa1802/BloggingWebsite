...
const CreatePost = (props: any) => {
  ...
  return (
    <div><Dialog open={props.open} onClose={props.handleClose}>
      {props.session?.user!==undefined ? <>  <DialogTitle className={styles.heading} variant='h4' >Upload New Blog</DialogTitle>
        <Divider />
        <DialogContent>
        ...
        <DialogContent>
          ...
          <DialogContentText className={styles.text}>
            Please Sign In to upload a blog.
          </DialogContentText>
